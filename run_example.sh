...
mkdir processsed_data/crawler_results
...
python confidence_prop.py -l zh -task extract --algorithm=tf_idf
python xlink.py
mv processsed_data/propagation_results/baike_context_tf_idf_baike_context_xlore_seed_nf_result.json processsed_data/propagation_results/baike_context_tf_idf_xlore_seed_nf_result.json
